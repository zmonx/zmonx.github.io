...
const t="default",i="inverse",n="multiline",l="password",r="search",o="text",a="number"
e.TYPE={SINGLE_LINE:o,PASSWORD:l,MULTI_LINE:n,SEARCH:r,NUMBER:a,array:[o,l,n,r,a]},e.COLORS={DEFAULT:t,INVERSE:i,array:[t,i]}}))
