...
const t="default",l="inverse",i="multiline",n="password",o="search",r="text",a="number"
e.TYPE={SINGLE_LINE:r,PASSWORD:n,MULTI_LINE:i,SEARCH:o,NUMBER:a,array:[r,n,i,o,a]},e.COLORS={DEFAULT:t,INVERSE:l,array:[t,l]}}))
