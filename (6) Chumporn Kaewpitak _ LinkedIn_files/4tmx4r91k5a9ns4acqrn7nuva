...
const t="default",i="inverse",l="multiline",n="password",o="search",r="text",a="number"
e.TYPE={SINGLE_LINE:r,PASSWORD:n,MULTI_LINE:l,SEARCH:o,NUMBER:a,array:[r,n,l,o,a]},e.COLORS={DEFAULT:t,INVERSE:i,array:[t,i]}}))
